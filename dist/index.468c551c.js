...
})({"f4owi":[function(require,module,exports) {
...
directive("model", (el, { modifiers, expression }, { effect: effect3, cleanup: cleanup2 })=>{
    ...
    if (modifiers.includes("fill")) {
        if ([
            ...
            null,
            ""
        ].includes(getValue()) || el.type === "checkbox" && Array.isArray(getValue())) setValue(getInputValue(el, modifiers, {
            target: el
        }, getValue()));
    }
...
},{}]},["f4owi","b9BDZ"], "b9BDZ", "parcelRequire7a7e")
